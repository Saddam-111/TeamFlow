...
export function Features() {
  return (
    <section id="features" className="py-24 bg-bg-black">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <span className="text-acid-yellow font-bold uppercase tracking-widest text-sm">Features</span>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {features.map((feature, index) => (
            <div
              key={index}
              className="group bg-surface border border-surface-light rounded-2xl p-8 hover:border-acid-yellow hover:shadow-xl hover:shadow-acid-yellow/10 transition-all duration-300"
            >
              <div className="w-14 h-14 bg-acid-yellow/10 rounded-xl flex items-center justify-center text-acid-yellow mb-6 group-hover:bg-acid-yellow group-hover:text-bg-black transition-all duration-300">
                {feature.icon}
              </div>
